...
if (1) {
  ...
  //note.alert = '杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵杨志兵';
  note.alert = '杨志兵';
  note.payload = {};
  console.log(note);

  let len = Buffer.byteLength(JSON.stringify(note), 'utf8');
  console.log(len);

  // {"hello":"world","aps":{"badge":3,"sound":"ping.aiff","alert":"You have a new message"}}
